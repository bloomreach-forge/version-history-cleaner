...
class DocumentHistoryCleanerTaskConstructorTest {
    ...
    void constructor_nullDocumentNode_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class,
                () -> new DocumentHistoryCleanerTask(session, null));
    }
    ...
    void constructor_nonVersionableNode_throwsIllegalArgumentException() throws RepositoryException {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new DocumentHistoryCleanerTask(session, documentNode));
    }
    ...
    void constructor_hstPrimaryType_throwsIllegalArgumentException() throws RepositoryException {
        when(primaryNodeType.getName()).thenReturn("hst:component");
        assertThrows(IllegalArgumentException.class,
                () -> new DocumentHistoryCleanerTask(session, documentNode));
    }
    ...
    @Test
    void getSetMaxRevisions_defaultIsNegativeOne() throws RepositoryException {
        final DocumentHistoryCleanerTask task = new DocumentHistoryCleanerTask(session, documentNode);
        org.junit.jupiter.api.Assertions.assertEquals(-1L, task.getMaxRevisions());
    }

    @Test
    void getSetMaxDays_defaultIsNegativeOne() throws RepositoryException {
        final DocumentHistoryCleanerTask task = new DocumentHistoryCleanerTask(session, documentNode);
        org.junit.jupiter.api.Assertions.assertEquals(-1L, task.getMaxDays());
    }

    @Test
    void setMaxRevisions_storesValue() throws RepositoryException {
        final DocumentHistoryCleanerTask task = new DocumentHistoryCleanerTask(session, documentNode);
        task.setMaxRevisions(5L);
        org.junit.jupiter.api.Assertions.assertEquals(5L, task.getMaxRevisions());
    }

    @Test
    void setMaxDays_storesValue() throws RepositoryException {
        final DocumentHistoryCleanerTask task = new DocumentHistoryCleanerTask(session, documentNode);
        task.setMaxDays(30L);
        org.junit.jupiter.api.Assertions.assertEquals(30L, task.getMaxDays());
    }
}
